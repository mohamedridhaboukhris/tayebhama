 ...
 */
final class Version20241114222526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, specialite_id INT NOT NULL, nom VARCHAR(50) NOT NULL, niveau VARCHAR(10) NOT NULL, annee INT NOT NULL, INDEX IDX_8F87BF962195E0F0 (specialite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
